    ...
    <div class="bg-indigo-950 dark:bg-gray-950 pt-20 font-nunito mb-16 md:mb-0">
        <div class="body-subcon">
            <div class="md:flex justify-between items-center">
                ...
                <div class="hidden md:flex justify-between md:gap-2 lg:gap-8">
                    <div>
                    ...
                    <div>
                        <a href="#qualification" class="footer-nav-link">Qualification</a>
                    </div>
                    <div>
                        <a href="#projects" class="footer-nav-link">Projects</a>
                    </div>
                    <div>
                        <a href="#message" class="footer-nav-link">Contact-Me</a>
                    </div>
                </div>
            </div>


            <div class="text-sm py-16 text-center text-white">© Anthony Nnanna. All Rights Reserved</div>
        </div>
    </div>
</template>