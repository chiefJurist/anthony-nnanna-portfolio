        ...
        <div class="body-subcon flex flex-wrap justify-center lg:justify-around items-center">
            ...
            <div class=" order-3 lg:order-2 pt-10">
                <div id="title" :class="{ 'animate-left': titleVisible }">
                    ...
                    <div class="font-bold text-xl mt-8 max-w-80">Senior Software Engineer</div>
                </div>

                <div class=" text-gray-600 dark:text-white text-lg mt-4 mb-8 max-w-96">
                    I architect fast, scalable, and secure digital products using Laravel, Vue, Rust, and Web3 technologies.
                </div>
